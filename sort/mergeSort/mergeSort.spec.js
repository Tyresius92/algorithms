...
describe('merge sort', () => {
  describe('merge function', () => {
    ...
    it('merges two arrays of different length with leftray longer', () => {
      expect(merge([1, 2, 3, 4, 6, 7, 8], [5])).toEqual([
        1,
        2,
        3,
        4,
    ...
    it('merges two arrays of different length with rightRay longer', () => {
